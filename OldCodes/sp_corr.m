...
% increasing distance class of spatial lag d using the Moran's coefficient 
% I given by:
%
...
%          lag is the distance up to which the Moran's coefficient will be 
%          calculated by default the maximum width of the matrix)
%          binsize  The size of the bins in the plot (default 1)
% I        the resulting spatial correlations are in this matrix (first column: 
%          lag; second column: correlation; third column the number of
%          points used. 
%
% References: Legendre P. & Fortin M.J.(1989). Spatial pattern and ecologival 
...
if varA<=1e-15
%disp('cannot calculate uniform matrix spatial correlation');
I1=999;
else
